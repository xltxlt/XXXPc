...
**data** | [**SysDocumentRule**](SysDocumentRule.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultSysDocumentRule } from './api';

const instance: RESTfulResultSysDocumentRule = {
    statusCode,
    data,
    succeeded,
    errors,
