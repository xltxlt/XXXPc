...
**data** | [**Array&lt;PagedOptions&gt;**](PagedOptions.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListPagedOptions } from './api';

const instance: RESTfulResultListPagedOptions = {
    statusCode,
    data,
    succeeded,
    errors,
