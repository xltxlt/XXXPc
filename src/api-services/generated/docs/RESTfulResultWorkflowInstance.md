...
**data** | [**WorkflowInstance**](WorkflowInstance.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultWorkflowInstance } from './api';

const instance: RESTfulResultWorkflowInstance = {
    statusCode,
    data,
    succeeded,
    errors,
