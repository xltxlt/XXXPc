...
**data** | [**PagedListSysMenu**](PagedListSysMenu.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultPagedListSysMenu } from './api';

const instance: RESTfulResultPagedListSysMenu = {
    statusCode,
    data,
    succeeded,
    errors,
