...
**data** | [**SysOrgTreeOutput**](SysOrgTreeOutput.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultSysOrgTreeOutput } from './api';

const instance: RESTfulResultSysOrgTreeOutput = {
    statusCode,
    data,
    succeeded,
    errors,
