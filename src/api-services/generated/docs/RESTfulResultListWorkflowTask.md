...
**data** | [**Array&lt;WorkflowTask&gt;**](WorkflowTask.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListWorkflowTask } from './api';

const instance: RESTfulResultListWorkflowTask = {
    statusCode,
    data,
    succeeded,
    errors,
