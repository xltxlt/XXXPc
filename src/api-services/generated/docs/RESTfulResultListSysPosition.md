...
**data** | [**Array&lt;SysPosition&gt;**](SysPosition.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysPosition } from './api';

const instance: RESTfulResultListSysPosition = {
    statusCode,
    data,
    succeeded,
    errors,
