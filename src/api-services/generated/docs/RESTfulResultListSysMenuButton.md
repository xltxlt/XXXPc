...
**data** | [**Array&lt;SysMenuButton&gt;**](SysMenuButton.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysMenuButton } from './api';

const instance: RESTfulResultListSysMenuButton = {
    statusCode,
    data,
    succeeded,
    errors,
