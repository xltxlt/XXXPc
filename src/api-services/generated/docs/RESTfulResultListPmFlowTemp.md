...
**data** | [**Array&lt;PmFlowTemp&gt;**](PmFlowTemp.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListPmFlowTemp } from './api';

const instance: RESTfulResultListPmFlowTemp = {
    statusCode,
    data,
    succeeded,
    errors,
