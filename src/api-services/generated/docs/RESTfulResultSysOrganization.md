...
**data** | [**SysOrganization**](SysOrganization.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultSysOrganization } from './api';

const instance: RESTfulResultSysOrganization = {
    statusCode,
    data,
    succeeded,
    errors,
