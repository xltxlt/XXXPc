...
**data** | [**Array&lt;SysDepartment&gt;**](SysDepartment.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysDepartment } from './api';

const instance: RESTfulResultListSysDepartment = {
    statusCode,
    data,
    succeeded,
    errors,
