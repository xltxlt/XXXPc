...
**data** | [**Array&lt;SysDictType&gt;**](SysDictType.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysDictType } from './api';

const instance: RESTfulResultListSysDictType = {
    statusCode,
    data,
    succeeded,
    errors,
