...
**data** | [**SysDepTreeOutput**](SysDepTreeOutput.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultSysDepTreeOutput } from './api';

const instance: RESTfulResultSysDepTreeOutput = {
    statusCode,
    data,
    succeeded,
    errors,
