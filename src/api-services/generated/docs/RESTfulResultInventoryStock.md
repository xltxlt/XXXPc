...
**data** | [**InventoryStock**](InventoryStock.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultInventoryStock } from './api';

const instance: RESTfulResultInventoryStock = {
    statusCode,
    data,
    succeeded,
    errors,
