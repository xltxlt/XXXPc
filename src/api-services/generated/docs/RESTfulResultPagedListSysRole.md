...
**data** | [**PagedListSysRole**](PagedListSysRole.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultPagedListSysRole } from './api';

const instance: RESTfulResultPagedListSysRole = {
    statusCode,
    data,
    succeeded,
    errors,
