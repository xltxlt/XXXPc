...
**data** | [**SysMenuOutputDto**](SysMenuOutputDto.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultSysMenuOutputDto } from './api';

const instance: RESTfulResultSysMenuOutputDto = {
    statusCode,
    data,
    succeeded,
    errors,
