...
**pageIndex** | **number** | 页面下标 | [default to undefined]
**pageSize** | **number** | 页面条数 | [default to undefined]

## Example

```typescript
import { PagedPaginationListDto } from './api';

const instance: PagedPaginationListDto = {
    menuId,
    menuCode,
    tenantId,
    where,
