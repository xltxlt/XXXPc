...
**data** | [**InventoryDomain**](InventoryDomain.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultInventoryDomain } from './api';

const instance: RESTfulResultInventoryDomain = {
    statusCode,
    data,
    succeeded,
    errors,
