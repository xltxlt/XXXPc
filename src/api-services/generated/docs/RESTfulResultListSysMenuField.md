...
**data** | [**Array&lt;SysMenuField&gt;**](SysMenuField.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListSysMenuField } from './api';

const instance: RESTfulResultListSysMenuField = {
    statusCode,
    data,
    succeeded,
    errors,
