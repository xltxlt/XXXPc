...
**data** | [**Array&lt;InventoryType&gt;**](InventoryType.md) |  | [optional] [default to undefined]
...
```typescript
import { RESTfulResultListInventoryType } from './api';

const instance: RESTfulResultListInventoryType = {
    statusCode,
    data,
    succeeded,
    errors,
